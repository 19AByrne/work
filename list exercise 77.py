...
def func():
    if yn == "Yes":
        ...
        if ny == "Yes":
            ...
            done = input("Are you done your list? ")
            if done == "Yes":
                pass
            elif done == "No":
                selected = str(input("Enter one of the names of the invited people. "))
                keep = input("Do you want this person to still come to the party? ")
                if keep == "Yes":
                    pass
                elif keep == "No":
                    invited.remove(selected)
